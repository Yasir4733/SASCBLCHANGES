...
CREATE TABLE  [Essentials].[Worker] (
  ...
  AllocatedMachines VARCHAR(MAX) DEFAULT NULL,
  CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
  UpdatedAt DATETIME NOT NULL DEFAULT GETDATE(),
...
CREATE TABLE  [Essentials].[Marker] (
  ...
  MarkerMapping VARCHAR(MAX) NOT NULL,
  CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
  UpdatedAt DATETIME NOT NULL DEFAULT GETDATE(),
...
CREATE TABLE  [Essentials].[Machine] (
  ...
  Operations VARCHAR(MAX) DEFAULT NULL,
  CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
  UpdatedAt DATETIME NOT NULL DEFAULT GETDATE(),
...
CREATE TABLE  [Data].[WorkerScan] (
  ...
  LineID INT NOT NULL,
  MachineID INT NOT NULL,
  WorkerOperations VARCHAR(MAX) NOT NULL,
  CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
  UpdatedAt DATETIME NOT NULL DEFAULT GETDATE(),
...
CREATE TABLE  [Essentials].[LineLayout] (
  ...
  LineLayoutOperationMachines VARCHAR(MAX) NOT NULL,
